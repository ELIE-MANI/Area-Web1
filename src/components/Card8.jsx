  ...
  return (
    ...
    <div class="flex flex-col items-center mt-10">
        ...
        <p class="mb-10 text-gray-500 ">Schedule a quick call to learn how Area can turn your regional data into a powerful advantage.</p>
         <button class="mb-10 w-[650px] bg-lime-800 hover:bg-lime-600 text-white font-bold py-4 px-4 rounded-full text-sm">Learn More <span class="ml-1  ">&rarr;</span></button>
    </div>
    </div>
  )
}
